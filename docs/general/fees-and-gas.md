...
- **Stellar** — every transaction pays network fees in XLM, including the call that starts a transfer. No VIA protocol fee is charged on Stellar routes during the launch period. See [VIA on Stellar → Fees](/docs/examples/stellar/overview#fees).
